...
func (x *GetVerifyCodeRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetVerifyCodeRes) ProtoMessage() {}

func (x *GetVerifyCodeRes) ProtoReflect() protoreflect.Message {
	mi := &file_api_customer_customer_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetVerifyCodeRes.ProtoReflect.Descriptor instead.
func (*GetVerifyCodeRes) Descriptor() ([]byte, []int) {
	return file_api_customer_customer_proto_rawDescGZIP(), []int{1}
}

func (x *GetVerifyCodeRes) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GetVerifyCodeRes) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GetVerifyCodeRes) GetVerifyCode() string {
	if x != nil {
		return x.VerifyCode
	}
	return ""
...
func (x *GetVerifyCodeRes) GetVerifyCodeTime() int64 {
	if x != nil {
...
func (x *GetVerifyCodeRes) GetVerifyCodeLife() int32 {
	if x != nil {
...
var file_api_customer_customer_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x22, 0xb5, 0x01, 0x0a, 0x10,
	...
	0x69, 0x66, 0x65, 0x32, 0x8a, 0x01, 0x0a, 0x08, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	0x12, 0x7e, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x64,
	...
	0x71, 0x1a, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	0x2e, 0x47, 0x65, 0x74, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65,
	0x73, 0x22, 0x2d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x27, 0x12, 0x25, 0x2f, 0x63, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x65, 0x72, 0x2f, 0x67, 0x65, 0x74, 0x2d, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x2d,
	0x63, 0x6f, 0x64, 0x65, 0x2f, 0x7b, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x7d,
...
var file_api_customer_customer_proto_goTypes = []interface{}{
	...
	(*GetVerifyCodeRes)(nil), // 1: api.customer.GetVerifyCodeRes
}
var file_api_customer_customer_proto_depIdxs = []int32{
	...
	1, // 1: api.customer.Customer.GetVerifyCode:output_type -> api.customer.GetVerifyCodeRes
