...
type GetVerifyCodeRequest struct {
	...
	Length uint32 `protobuf:"varint,1,opt,name=length,proto3" json:"length,omitempty"`                      //验证码长度
	Type   TYPE   `protobuf:"varint,2,opt,name=type,proto3,enum=api.verifyCode.TYPE" json:"type,omitempty"` //验证码类型
}
...
var file_api_verifyCode_verifyCode_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x39, 0x0a, 0x0e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x65, 0x72,
	0x69, 0x66, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x50, 0x01, 0x5a, 0x25, 0x76, 0x65, 0x72, 0x69, 0x66,
	0x79, 0x2d, 0x63, 0x6f, 0x64, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x65, 0x72, 0x69, 0x66,
	0x79, 0x43, 0x6f, 0x64, 0x65, 0x3b, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x64, 0x65,
